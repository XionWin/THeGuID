...
namespace Pencil.Graphics.Colors
{
    /// <summary>
    ...
    partial struct Color4
    {
        ...
        public override bool Equals(object obj) => obj is Color4 c4 ? this.Equals(c4) : false;

        public static bool operator ==(Color4 left, Color4 right) => left.Equals(right);

        public static bool operator !=(Color4 left, Color4 right) => !left.Equals(right);

        public override string ToString() => $"R: {this.R}, G: {this.G}, B: {this.B}, R: {this.A}";
    }
